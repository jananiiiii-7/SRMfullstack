...
public class TestInterfaceFactory {
    public static void main(String[] args) {
        ...
        // TODO: After completing IAccount, AbstractAccount and AccountFactory,
        // uncomment the test calls
        // below and run this program. Your output should match the "Expected Output"
        // section of README.md.

        IAccount acc1 = AccountFactory.createAccount("SAVINGS", "SAV1001", "Rajesh Sharma", 28, 5000.0, "ACTIVE",
                "1234");
        System.out.println("Factory created: " + acc1.getAccountType() + " account for " + acc1.getName());
        //
        IAccount acc2 = AccountFactory.createAccount("CURRENT", "CUR1001", "Priya Patel", 34, 10000.0, "ACTIVE",
                "5678");
